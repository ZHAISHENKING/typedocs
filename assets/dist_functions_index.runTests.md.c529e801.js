import{_ as e,c as t,o as s,a as o}from"./app.8ea3f0da.js";const _=JSON.parse('{"title":"Function: runTests","description":"","frontmatter":{},"headers":[],"relativePath":"dist/functions/index.runTests.md"}'),n={name:"dist/functions/index.runTests.md"},a=o(`<h1 id="function-runtests" tabindex="-1">Function: runTests <a class="header-anchor" href="#function-runtests" aria-hidden="true">#</a></h1><p><a href="./../modules/">index</a>.runTests</p><p><strong>runTests</strong>(<code>opts?</code>): <code>Promise</code>&lt;<a href="./../interfaces/index.TestMessage.html"><code>TestMessage</code></a>[<code>&quot;end&quot;</code>]&gt; &amp; {}</p><p>Run any tests which have been registered via <code>Deno.test()</code>. Always resolves asynchronously.</p><p><strong><code>I18n</code></strong></p><p>\u8FD0\u884C\u6240\u6709\u901A\u8FC7 <code>Deno.test()</code> \u6CE8\u518C\u7684\u6D4B\u8BD5\u3002\u59CB\u7EC8\u5F02\u6B65 resolve\u3002</p><pre><code>   // \u6CE8\u518C\u4E00\u4E2A\u6D4B\u8BD5\u3002
   Deno.test({
     name: &quot;example test&quot;,
     fn(): void {
